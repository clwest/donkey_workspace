...
urlpatterns = [
    ...
    path("api/epistemic-currents/", agent_views.epistemic_currents),
    path("api/feedback-anchors/", agent_views.feedback_anchors),
    path("api/knowledge-ecology/", agent_views.knowledge_ecology_maps),
