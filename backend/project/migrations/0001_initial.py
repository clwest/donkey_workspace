            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        through="project.ProjectParticipant",
                        to="accounts.customuser",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="team_projects",
                        to="assistants.assistantmemorychain",
                    ),
                ),
                (
                    "assistant",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="assistants.assistantproject",
                    ),
                ),
                (
                    "narrative_thread",
                ...
                (
                    "dev_docs",
                    models.ManyToManyField(
                        blank=True, related_name="projects", to="mcp_core.devdoc"
                    ),
                ),
                (
                    "created_from_memory",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "memory",
                    models.ForeignKey(
                        on_delete=models.CASCADE, to="memory.memoryentry"
                    ),
                ),
                (
                    "project",
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=["project", "memory"], name="unique_project_memory"
                    ),
                ],
            },
        ),
