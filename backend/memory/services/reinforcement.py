...
__all__ = ["reinforce_glossary_anchor", "anchor_reinforcement_log", "REINFORCEMENT_THRESHOLD"]
...
def reinforce_glossary_anchor(
    ...
    *,
    ...
    rtag, _ = Tag.objects.get_or_create(slug="reinforcement", defaults={"name": "reinforcement"})
    mem.tags.add(gtag, rtag)
    anchor_reinforcement_log(anchor, assistant=assistant, memory=mem, reason=source, score=score)
