...
urlpatterns = [
    ...
    path("api/forecasting-ledgers/", agent_views.forecasting_ledgers),
    path("api/future-contracts/", agent_views.future_contracts),
    path("api/cosmo-alignment/", agent_views.cosmo_alignment),
