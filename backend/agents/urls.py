...
urlpatterns = [
    ...
    path("ritual-mastery/", agents.ritual_mastery_records),
    path("pilgrimages/", agents.pilgrimages),
    path("reincarnation/", agents.reincarnation_interface),
    ...
    path("ritual-blueprints/", agents.ritual_blueprints),
    path("ritual-simulations/", agents.ritual_simulations),
    path("memory-reprogramming/", agents.memory_reprogramming),
