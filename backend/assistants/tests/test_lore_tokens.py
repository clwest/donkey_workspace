...
from agents.models import SwarmMemoryEntry, LoreToken, Agent
from agents.utils.lore_token import compress_memories_to_token, apply_lore_token_to_agent
...
class LoreTokenTest(TestCase):
    ...
    def test_apply_lore_token_to_agent(self):
        ...
        token = LoreToken.objects.create(
            name="t", summary="s", symbolic_tags={"skills": ["alpha"]}, embedding=[0.0] * EMBEDDING_LENGTH, created_by=assistant
        )
