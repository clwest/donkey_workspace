...
urlpatterns = [
    ...
    path("training-grounds/", agents.training_grounds),
    path("myth-edit-log/", agents.myth_edit_log),
    path("legacy-continuity-vaults/", agents.legacy_continuity_vaults),
    ...
    path("purpose-grafts/", agents.purpose_grafts),
    path("succession-rituals/", agents.succession_rituals),
    path("reincarnation-forest/", agents.reincarnation_forest),
