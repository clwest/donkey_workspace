    ...
    <Router>
      ...
      <Navbar />
        ...
        <Routes>
          ...
          <Route path="/assistants/:slug/thoughts/:id" element={<AssistantThoughtDetailPage />} />
          ...
          <Route path="/assistants               " element={<ObjectivesPage />} />
          ...
          <Route path="/grouped-reflections" element={<GroupedReflectionsPage />} />
