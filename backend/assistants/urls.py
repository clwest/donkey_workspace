...
urlpatterns = [
    ...
    path(
        "<slug:slug>/demo_session/<uuid:session_id>/rag_overlay/",
        demo.demo_rag_overlay,
        name="demo_rag_overlay",
    ),
    path(
        "<slug:slug>/demo_session/<uuid:session_id>/drift_diagnosis/",
        demo.demo_drift_diagnosis,
        name="demo_drift_diagnosis",
    ),
    path(
    ...
    path(
        ...
        diagnostics.get_assistant_diagnostic_report,
        name="assistant-diagnostic-report",
    ),
    path(
    ...
    path(
        "<slug:slug>/drift_fixes/",
        assistants.drift_fixes,
        name="assistant-drift-fixes",
    ),
    path(
    ...
    path(
        "<slug:slug>/tools/confidence/",
        views.tool_confidence,
        name="assistant-tool-confidence",
    ),
    path(
        "<slug:slug>/tools/recommend/",
        views.recommend_tool_changes,
        name="assistant-tool-recommend",
    ),
    path(
